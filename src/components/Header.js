...
const Header = () => {
    ...
    return (
        <>
                        ...
                        <div className="container mx-auto px-6 py-4">
                            <div className="flex items-center justify-between">
                                ...
                                <div onClick={() => setToggle(!toggle)} className="block lg:hidden pr-0">
                                    <button id="nav-toggle" className="flex items-center p-1 text-gray-900 hover:text-gray-600 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">

                                        {!toggle ? <svg className="text-gray-800 fill-current h-6 w-6" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <title>Menu</title>
                                            <path d="M0 3h20v2H0V3zm0 6h20v2H0V9zm0 6h20v2H0v-2z" />
                                        </svg> : <svg className="text-gray-800" xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className={`absolute inset right-0 w-80  bg-indigo-600 h-screen transform duration-300 ${toggle ? "translate-x-0 ease-in opacity-100" : "translate-x-full ease-out opacity-30"}   `}>
                <ul>
                    <li className="block text-gray-100 cursor-pointer font-extrabold px-4 py-2 hover:bg-indigo-800 rounded-md text-center mt-10">Home </li>
                    <li className="block text-gray-100 cursor-pointer font-extrabold px-4 py-2 hover:bg-indigo-800 rounded-md text-center">Home </li>
                    <li className="block text-gray-100 cursor-pointer font-extrabold px-4 py-2 hover:bg-indigo-800 rounded-md text-center">Home </li>
                    <li className="block text-gray-100 cursor-pointer font-extrabold px-4 py-2 hover:bg-indigo-800 rounded-md text-center">Home </li>
                </ul>
            </div>
