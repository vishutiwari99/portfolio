...
const Header = () => {
    ...
    return (
        <>
                            ...
                            <div class="flex items-center justify-between">
                                <div>
                                    <a class="flex items-center text-gray-800 hover:text-indigo-600" href="#">
                                        ...
                                        <span class="mx-3 font-medium text-sm md:text-base">Vaibhav Tiwari</span>
                                    </a>
                                </div>
                                <div onClick={() => setToggle(!toggle)} class="block lg:hidden pr-0">
            ...
            <div className={`absolute right-0 w-80  bg-indigo-700 h-screen transform duration-300 ${toggle ? "translate-x-0 ease-in opacity-100" : "translate-x-full ease-out opacity-30"}   `}>
                <ul>
                    <li className="block px-4 py-2 hover:bg-indigo-800 rounded-md text-center mt-10">Home </li>
                    <li className="block px-4 py-2 hover:bg-indigo-800 rounded-md text-center">Home </li>
                    <li className="block px-4 py-2 hover:bg-indigo-800 rounded-md text-center">Home </li>
                    <li className="block px-4 py-2 hover:bg-indigo-800 rounded-md text-center">Home </li>
                </ul>
            </div>
